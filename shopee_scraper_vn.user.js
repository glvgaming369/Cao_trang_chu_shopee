            ...
            panel.innerHTML = `
                ...
                <div style="margin-bottom: 10px; display: flex; gap: 8px;">
                    <div style="flex: 1; display: flex; flex-direction: column;">
                        <label style="display: block; margin-bottom: 4px; font-weight: bold; font-size: 11px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: #ccc;" title="Giá tối thiểu (₫)">Giá Min (₫):</label>
                    ...
                    <div style="flex: 1; display: flex; flex-direction: column;">
                        <label style="display: block; margin-bottom: 4px; font-weight: bold; font-size: 11px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: #ccc;" title="Đã bán tối thiểu">Đã bán Min:</label>
                    ...
                    <div style="flex: 1; display: flex; flex-direction: column;">
                        <label style="display: block; margin-bottom: 4px; font-weight: bold; font-size: 11px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; color: #ccc;" title="Hoa hồng người bán tối thiểu (₫)">HH Min (₫):</label>
                        <input type="number" id="scraper-com-min" value="${sheetConfig.sellerCommissionMin}" style="width: 100%; padding: 5px; border-radius: 4px; border: 1px solid #444; background-color: #2b2b2b; color: white; font-size: 12px; box-sizing: border-box;">
                    </div>
                </div>
